# Chapter 2: Problem Solving Basics & Set Theory
...
From this final "proof" in {prf:ref}`injsurjbij`, we can infer a lot of information. For clarity, if $f$ is bijective, each object has a distinct box *and* each box has a distinct object. If we wi to reverse the process of assignment $f$ has committed, we could easily do so: simply reverse each assignment! This thinking leads to the following theorem:
